...
// The values for email, username, and birthday will be passed in when the object is created so don't forget to add these three parameters in the constructor method.
...
// Create a variable called user1. Set this variable to a instance of the User class. Pass in the following arguments for email, username, and birthday respectively. Suggestion: Try copying and pasting the values instead of retyping them.
