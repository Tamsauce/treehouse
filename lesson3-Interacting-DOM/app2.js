...
//this will make the li(s) uppercase when you hover over one.  This will only change the first element [0]
...
//     listItems[i].textContent = listItem[i].textContent.toUpperCase();                   
//  });
//}
